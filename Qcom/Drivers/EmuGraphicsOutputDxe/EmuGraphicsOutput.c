  ...
  )
{
  ...
  Private->ModeInfo.HorizontalResolution = 800;
  Private->ModeInfo.VerticalResolution = 600;
  ...
  Private->GraphicsOutputMode.FrameBufferSize = Private->ModeInfo.HorizontalResolution * Private->ModeInfo.VerticalResolution * 3;
  Private->GraphicsOutputMode.FrameBufferBase = (UINTN)AllocatePool (Private->GraphicsOutputMode.FrameBufferSize);
